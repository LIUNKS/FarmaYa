CREATE DATABASE IF NOT EXISTS farmaya CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE farmaya;
...
-- Productos (ACTUALIZADO con campo imagen_url)
CREATE TABLE IF NOT EXISTS Producto (
  ...
  imagen_url VARCHAR(500),  -- NUEVO CAMPO para la ruta de la imagen
  stock INT NOT NULL DEFAULT 0,  -- Campo de stock agregado
...
-- ####################################################################################
-- PASO 1: INSERTAR LOS PROVEEDORES (LABORATORIOS)
-- Se insertan todos los proveedores únicos para asegurar que los 120 productos tengan su referencia.
-- ####################################################################################
...
-- ####################################################################################
-- PASO 2: INSERTAR LOS 120 PRIMEROS PRODUCTOS DEL ARCHIVO
-- ####################################################################################
INSERT INTO Producto (sku, nombre, presentacion, principio_activo, precio, categoria, imagen_url, stock, proveedor_id, activo) VALUES
...
-- ####################################################################################
-- PASO 3: INSERTAR LOS LOTES PARA LOS 120 PRIMEROS PRODUCTOS
-- ####################################################################################
INSERT INTO LoteProducto (producto_id, numero_lote, cantidad, fecha_vencimiento) VALUES
